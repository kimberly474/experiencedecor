...
<head>
    ...
    <title>Oval Small Decorative Mirror |Style Interiors</title>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="wpo-breadcumb-wrap">
                            <h2>Oval Small Decorative Mirror</h2>
                            <ol class="wpo-breadcumb-wrap">
                                <li><a href="/">Home</a></li>
                                <li>Oval Small Decorative Mirror</li>
                            </ol>
                        </div>
                    </div>
                </div> <!-- end row -->
                ...
                <div class="row">
                    <div class="col col-lg-6 col-12">
                        <div class="shop-single-slider">
                            <div class="slider-for">
                                ...
                                <div><img src="assets/images/sub3.jpg" alt></div>
                    ...
                    <div class="col col-lg-6 col-12">
                        <div class="product-details">
                            ...
                            <p>Asymmetric Oval Small Decorative Mirror Framed Hanging Mirrors for Home Farmhouse Entryway Porch Housewarming 24 inch Mirror (Black)</p>
                                <ul>
                                    <li>Room Type - Bathroom, Bedroom, Livinr Room, Hallway, Dining Room</li>
                                    <li>Shape - Round</li>
                                    <li>Product Dimensions - 60L x 60W Centimeters</li>
