...
<head>
    ...
    <title>Self-Adhesive Wall Sticker |Style Interiors</title>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="wpo-breadcumb-wrap">
                            <h2>Self-Adhesive Wall Sticker</h2>
                            <ol class="wpo-breadcumb-wrap">
                                <li><a href="/">Home</a></li>
                                <li>Self-Adhesive Wall Sticker</li>
                            </ol>
                        </div>
                    </div>
                </div> <!-- end row -->
                ...
                <div class="row">
                    <div class="col col-lg-6 col-12">
                        <div class="shop-single-slider">
                            <div class="slider-for">
                                ...
                                <div><img src="assets/images/sub2.jpg" alt></div>
                    ...
                    <div class="col col-lg-6 col-12">
                        <div class="product-details">
                            ...
                            <p>Sticker Yard PVC Vinyl Tree and Flowers Branch Leaves Self-Adhesive Wall Sticker for Home Decor/Decoration - Living Room, Bedroom, Kids Room (Multicolor, Size: 127X84 cms)</p>
                                <ul>
                                    <li>Colour - Multicolor</li>
                                    <li>Item dimensions L x W x H - 84 x 127 x 1 Centimeters</li>
                                    <li>Special Feature - Silent Clock</li>
                                    <li>Cartoon Character - Tree and Flowers</li>
                                </ul>
