...
<head>
    ...
    <title>Products |Style Interiors</title>
...
<body>
                    ...
                    <div class="col col-xs-12">
                        <div class="shop-grids clearfix">
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="#;">Glass Analog Wall Clock</a></h3>
                                    <del>$30.00</del><span>$22.00</span>
                                    <div class="add-to-cart">
                                        <a href="glass-analog-wall-clock.php">Read More<i class="ti-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="#;">Self-Adhesive Wall Sticker</a></h3>
                                    <del>$20.00</del><span>$13.00</span>
                                    <div class="add-to-cart">
                                        <a href="self-adhesive-wall-sticker.php">Read More<i class="ti-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                                ...
                                <div class="details">
                                    <h3><a href="#;">Oval Small Decorative Mirror</a></h3>
                                    <del>$45.00</del><span>$35.00</span>
                                    <div class="add-to-cart">
                                        <a href="oval-small-decorative-mirror.php">Read More<i class="ti-shopping-cart"></i></a>
                                    </div>
                                </div>
                            </div>
 ...
 <!-- start Arkitek-cta-section -->
 <section class="Arkitek-cta-section section-padding">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7 col-12">
                <div class="cta-content">
                    ...
                    <div class="cta-btn">
                        <a class="theme-btn" href="contact-us.php">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
...
<button class="chatbot-toggler">
    <span class="material-symbols-rounded"><img src="assets/images/phone.png"></span>
    <span class="material-symbols-outlined"><img src="assets/images/close.png"></span>
</button>
<div class="chatbot">
    <header>
        <h2>Hello</h2>
